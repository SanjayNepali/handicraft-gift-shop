    ...
    <main className={styles.main}>
      <div className="container container--narrow">
        ...
        <p className={styles.paragraph}>
          {APP_NAME} began with a simple belief: gifts mean more when they
          carry the hands and heart of the person who made them. We work
          with local artisans across Nepal to bring handcrafted pieces —
          each one imperfectly perfect — into homes around the world.
        </p>
        <p className={styles.paragraph}>
